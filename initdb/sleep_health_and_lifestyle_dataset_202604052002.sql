-- sleep_health_and_lifestyle_dataset_202604052002.sql
...
-- Create table
CREATE TABLE IF NOT EXISTS health.sleep_health_and_lifestyle_dataset (
    "Person_ID"               INTEGER       NOT NULL,
    "Gender"                  VARCHAR(10),
    "Age"                     SMALLINT,
    "Occupation"              VARCHAR(100),
    "Sleep Duration"          NUMERIC(3,1),
    "Quality of Sleep"        SMALLINT,
    "Physical Activity Level" SMALLINT,
    "Stress Level"            SMALLINT,
    "BMI Category"            VARCHAR(20),
    "Blood Pressure"          VARCHAR(10),
    "Heart Rate"              SMALLINT,
    "Daily Steps"             INTEGER,
    "Sleep Disorder"          VARCHAR(20),

    CONSTRAINT pk_sleep_health_and_lifestyle_dataset PRIMARY KEY ("Person_ID")
);
INSERT INTO health.sleep_health_and_lifestyle_dataset (
    "Person_ID","Gender","Age","Occupation","Sleep Duration",
...
VALUES
	 ...
	 (53,'Male',32,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (54,'Male',32,'Doctor',7.6,7,75,6,'Normal','120/80',70,8000,'None'),
	 (55,'Male',32,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (56,'Male',32,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (57,'Male',32,'Doctor',7.7,7,75,6,'Normal','120/80',70,8000,'None'),
	 (58,'Male',32,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (59,'Male',32,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (60,'Male',32,'Doctor',7.7,7,75,6,'Normal','120/80',70,8000,'None'),
	 (61,'Male',32,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (62,'Male',32,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 ...
	 (75,'Male',33,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (76,'Male',33,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (77,'Male',33,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (78,'Male',33,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (79,'Male',33,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 (80,'Male',33,'Doctor',6.0,6,30,8,'Normal','125/80',72,5000,'None'),
	 ...
	 (151,'Female',39,'Accountant',8.0,9,80,3,'Normal Weight','115/78',67,7500,'None'),
	 ...
	 (281,'Female',50,'Nurse',6.0,6,90,8,'Overweight','140/95',75,10000,'None'),
...
ON CONFLICT ("Person_ID") DO NOTHING;   -- idempotent: skip duplicates on re-run
